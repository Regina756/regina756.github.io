...
<div class="flex items-center justify-center min-h-screen bg-[url('/images/Landscape2.png')] bg-cover bg-center">
  ...
  <div class="w-[90%] sm:w-[30%] p-8 rounded-2xl border border-white/30 bg-black/30 backdrop-blur-md shadow-2xl">
    <h1 class="text-3xl text-center font-bold text-white drop-shadow mb-6">Register</h1>
    ...
    <form class="flex flex-col gap-4" action="/authenticate" method="post">
      ...
      <div class="flex flex-col">
        <label class="text-sm font-medium text-white drop-shadow">Name</label>
        <input
          ...
          type="text" name="name" autocomplete="off" placeholder="Enter your Email"
        />
      </div>
      ...
      <button
        type="submit"
        class="w-full py-2 font-bold text-lg rounded-lg bg-gray-100 text-black shadow-lg hover:bg-gray-200 transition-all drop-shadow-md"
            >
        Submit
            </button>
